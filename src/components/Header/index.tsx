                      ...
                      <li key={index} className="group relative">
                        {menuItem.path ? (
                          <Link
                            ...
                            className={`${classes.textBaseC} flex py-2 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${
                              usePathName === menuItem.path
                                ? `${classes.textPrimaryC}`
                                : `${classes.textDarkC} text-dark`
                            }`}
                          >
                            {menuItem.title}
                          </Link>
                          ...
                          <>
                            <p
                              ...
                              className={`${classes.textBaseC} flex cursor-pointer items-center justify-between py-2 text-dark  lg:mr-0 lg:inline-flex lg:px-0 lg:py-6`}
                            >
                              {menuItem.title}
                              <span className="pl-3">
                            ...
                            >
                              {menuItem.submenu.map((submenuItem, index) => (
                                <Link
                                  ...
                                  className={`${classes.textDarkC} ${classes.textSmC} block rounded py-2.5  text-dark lg:px-3`}
                                >
                                  {submenuItem.title}
                                </Link>
                              ))}
